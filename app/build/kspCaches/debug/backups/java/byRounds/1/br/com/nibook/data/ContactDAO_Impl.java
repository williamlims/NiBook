...
public final class ContactDAO_Impl implements ContactDAO {
  ...
  public ContactDAO_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfContact = new EntityInsertionAdapter<Contact>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `Contact` (`id`,`name`,`surname`,`birthday`,`phone`,`email`) VALUES (nullif(?, 0),?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfContact = new EntityDeletionOrUpdateAdapter<Contact>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `Contact` SET `id` = ?,`name` = ?,`surname` = ?,`birthday` = ?,`phone` = ?,`email` = ? WHERE `id` = ?";
      }
  ...
  public LiveData<List<Contact>> getAll() {
    final String _sql = "SELECT * FROM contact ORDER BY name";
      ...
      public List<Contact> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Contact(_tmpId,_tmpName,_tmpSurname,_tmpBirthday,_tmpPhone,_tmpEmail);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public LiveData<Contact> getContact(final int contactid) {
      ...
      public Contact call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final String _tmpEmail;
            _tmpEmail = _cursor.getString(_cursorIndexOfEmail);
            _result = new Contact(_tmpId,_tmpName,_tmpSurname,_tmpBirthday,_tmpPhone,_tmpEmail);
          } else {
            _result = null;
          }
          return _result;
